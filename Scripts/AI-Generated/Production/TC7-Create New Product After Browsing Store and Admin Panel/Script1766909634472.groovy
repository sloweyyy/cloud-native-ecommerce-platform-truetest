...
// WebUI.takeScreenshot(reportLocation + '/TC7/Step 4-Click on button store - Navigate to page store.png')

"Step 5: Click on button signIn"

WebUI.enhancedClick(findTestObject('AI-Generated/Production/Page_store/button_signIn'))

// WebUI.takeScreenshot(reportLocation + '/TC7/Step 5-Click on button signIn.png')
...
// WebUI.takeScreenshot(reportLocation + '/TC7/Step 6-Click on item signIn2 - Navigate to page login.png')

"Step 7: Click on button signInWithAzureAd -> Navigate to page '/'"

WebUI.enhancedClick(findTestObject('AI-Generated/Production/Page_login/button_signInWithAzureAd'))

// WebUI.takeScreenshot(reportLocation + '/TC7/Step 7-Click on button signInWithAzureAd - Navigate to page .png')

"Step 8: Click on button store -> Navigate to page '/store'"

WebUI.enhancedClick(findTestObject('AI-Generated/Production/Page_home/button_store'))

// WebUI.takeScreenshot(reportLocation + '/TC7/Step 8-Click on button store - Navigate to page store.png')

"Step 9: Click on input search"

WebUI.enhancedClick(findTestObject('AI-Generated/Production/Page_store/input_search'))

// WebUI.takeScreenshot(reportLocation + '/TC7/Step 9-Click on input search.png')

"Step 10: Click on div brandAcer"

WebUI.enhancedClick(findTestObject('AI-Generated/Production/Page_store/div_brandAcer'))

// WebUI.takeScreenshot(reportLocation + '/TC7/Step 10-Click on div brandAcer.png')
...
// WebUI.takeScreenshot(reportLocation + '/TC7/Step 11-Click on button viewDetails.png')
...
// WebUI.takeScreenshot(reportLocation + '/TC7/Step 14-Click on button viewDetails.png')

"Step 15: Click on button backToStore"

WebUI.enhancedClick(findTestObject('AI-Generated/Production/Page_store/button_backToStore'))

// WebUI.takeScreenshot(reportLocation + '/TC7/Step 15-Click on button backToStore.png')

"Step 16: Click on item product2"

WebUI.enhancedClick(findTestObject('AI-Generated/Production/Page_store/item_product2'))

// WebUI.takeScreenshot(reportLocation + '/TC7/Step 16-Click on item product2.png')

"Step 17: Click on span default"

WebUI.enhancedClick(findTestObject('AI-Generated/Production/Page_store/span_default'))

// WebUI.takeScreenshot(reportLocation + '/TC7/Step 17-Click on span default.png')

"Step 18: Click on span default"

WebUI.enhancedClick(findTestObject('AI-Generated/Production/Page_store/span_default'))

// WebUI.takeScreenshot(reportLocation + '/TC7/Step 18-Click on span default.png')
...
// WebUI.takeScreenshot(reportLocation + '/TC7/Step 19-Click on button home - Navigate to page admin.png')
...
// WebUI.takeScreenshot(reportLocation + '/TC7/Step 20-Click on button createNewProduct - Navigate to page adminproductsnew.png')
...
// WebUI.takeScreenshot(reportLocation + '/TC7/Step 22-Click on div productName.png')

"Step 23: Click on input productName"

WebUI.enhancedClick(findTestObject('AI-Generated/Production/Page_admin_products_new/input_productName'))

// WebUI.takeScreenshot(reportLocation + '/TC7/Step 23-Click on input productName.png')
...
// WebUI.takeScreenshot(reportLocation + '/TC7/Step 24-Enter input value in input productName.png')
...
// WebUI.takeScreenshot(reportLocation + '/TC7/Step 25-Click on input summary.png')
...
// WebUI.takeScreenshot(reportLocation + '/TC7/Step 26-Enter input value in input summary.png')
...
// WebUI.takeScreenshot(reportLocation + '/TC7/Step 27-Click on textarea description.png')

"Step 28: Click on input summary"

WebUI.enhancedClick(findTestObject('AI-Generated/Production/Page_admin_products_new/input_summary'))

// WebUI.takeScreenshot(reportLocation + '/TC7/Step 28-Click on input summary.png')
...
// WebUI.takeScreenshot(reportLocation + '/TC7/Step 29-Enter input value in input summary.png')

"Step 30: Click on textarea description"

WebUI.enhancedClick(findTestObject('AI-Generated/Production/Page_admin_products_new/textarea_description'))

// WebUI.takeScreenshot(reportLocation + '/TC7/Step 30-Click on textarea description.png')
...
// WebUI.takeScreenshot(reportLocation + '/TC7/Step 31-Enter input value in textarea description.png')

"Step 32: Click on input summary"

WebUI.enhancedClick(findTestObject('AI-Generated/Production/Page_admin_products_new/input_summary'))

// WebUI.takeScreenshot(reportLocation + '/TC7/Step 32-Click on input summary.png')
...
// WebUI.takeScreenshot(reportLocation + '/TC7/Step 34-Click on div productDescription.png')

"Step 35: Click on input productName"

WebUI.enhancedClick(findTestObject('AI-Generated/Production/Page_admin_products_new/input_productName'))

// WebUI.takeScreenshot(reportLocation + '/TC7/Step 35-Click on input productName.png')
...
// WebUI.takeScreenshot(reportLocation + '/TC7/Step 36-Enter input value in input productName.png')
...
// WebUI.takeScreenshot(reportLocation + '/TC7/Step 37-Click on label summary.png')

"Step 38: Click on input summary"

WebUI.enhancedClick(findTestObject('AI-Generated/Production/Page_admin_products_new/input_summary'))

// WebUI.takeScreenshot(reportLocation + '/TC7/Step 38-Click on input summary.png')
...
// WebUI.takeScreenshot(reportLocation + '/TC7/Step 39-Enter input value in input summary.png')
...
// WebUI.takeScreenshot(reportLocation + '/TC7/Step 40-Click on label description.png')

"Step 41: Click on textarea description"

WebUI.enhancedClick(findTestObject('AI-Generated/Production/Page_admin_products_new/textarea_description'))

// WebUI.takeScreenshot(reportLocation + '/TC7/Step 41-Click on textarea description.png')
...
// WebUI.takeScreenshot(reportLocation + '/TC7/Step 42-Enter input value in textarea description.png')
...
// WebUI.takeScreenshot(reportLocation + '/TC7/Step 43-Click on input price.png')
...
// WebUI.takeScreenshot(reportLocation + '/TC7/Step 44-Enter input value in input price.png')
...
// WebUI.takeScreenshot(reportLocation + '/TC7/Step 45-Click on input brand.png')

"Step 46: Click on div productItems (productHp)"
...
// WebUI.takeScreenshot(reportLocation + '/TC7/Step 46-Click on div productItems productHp.png')

"Step 47: Click on input type"

WebUI.enhancedClick(findTestObject('AI-Generated/Production/Page_admin_products_new/input_type'))

// WebUI.takeScreenshot(reportLocation + '/TC7/Step 47-Click on input type.png')

"Step 48: Click on div productItems (keyboards)"
...
// WebUI.takeScreenshot(reportLocation + '/TC7/Step 48-Click on div productItems keyboards.png')
...
// WebUI.takeScreenshot(reportLocation + '/TC7/Step 49-Click on span uploadImage.png')

"Step 50: Click on input price"

WebUI.enhancedClick(findTestObject('AI-Generated/Production/Page_admin_products_new/input_price'))

// WebUI.takeScreenshot(reportLocation + '/TC7/Step 50-Click on input price.png')
...
// WebUI.takeScreenshot(reportLocation + '/TC7/Step 51-Enter input value in input price.png')
...
// WebUI.takeScreenshot(reportLocation + '/TC7/Step 53-Click on span upload.png')
...
// WebUI.takeScreenshot(reportLocation + '/TC7/Step 55-Click on div imageUpload.png')

"Step 56: Click on span uploadImage"

WebUI.enhancedClick(findTestObject('AI-Generated/Production/Page_admin_products_new/span_uploadImage'))

// WebUI.takeScreenshot(reportLocation + '/TC7/Step 56-Click on span uploadImage.png')
...
// WebUI.takeScreenshot(reportLocation + '/TC7/Step 57-Click on item brandsAndTypes - Navigate to page adminbrands-types.png')
...
// WebUI.takeScreenshot(reportLocation + '/TC7/Step 58-Click on item orders - Navigate to page adminorders.png')
...
// WebUI.takeScreenshot(reportLocation + '/TC7/Step 59-Click on item products - Navigate to page adminproducts.png')
...
// WebUI.takeScreenshot(reportLocation + '/TC7/Step 60-Click on item dashboard - Navigate to page admin.png')
...
// WebUI.takeScreenshot(reportLocation + '/TC7/Step 61-Click on item products - Navigate to page .png')

"Step 62: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC7-Create New Product After Browsing Store and Admin Panel_visual_checkpoint')
