...
// WebUI.takeScreenshot(reportLocation + '/TC7/Step 4-Click on button addToCart addToCart5.png')
...
// WebUI.takeScreenshot(reportLocation + '/TC7/Step 5-Click on button addToCart addToCart6.png')

"Step 6: Click on button addToCart (addToCart7)"
...
// WebUI.takeScreenshot(reportLocation + '/TC7/Step 6-Click on button addToCart addToCart7.png')

"Step 7: Click on button addToCart (addToCart5)"
...
// WebUI.takeScreenshot(reportLocation + '/TC7/Step 7-Click on button addToCart addToCart5.png')

"Step 8: Click on button cartActions (cart) -> Navigate to page '/checkout'"
...
// WebUI.takeScreenshot(reportLocation + '/TC7/Step 8-Click on button cartActions cart - Navigate to page checkout.png')

"Step 9: Click on button quantityAdjustments (plus)"

WebUI.enhancedClick(findTestObject('AI-Generated/Production/Dynamic Objects/Page_checkout/button_quantityAdjustments'))

// WebUI.takeScreenshot(reportLocation + '/TC7/Step 9-Click on button quantityAdjustments plus.png')
...
// WebUI.takeScreenshot(reportLocation + '/TC7/Step 10-Click on span checkoutButton.png')
...
// WebUI.takeScreenshot(reportLocation + '/TC7/Step 11-Click on span increaseValue.png')
...
// WebUI.takeScreenshot(reportLocation + '/TC7/Step 12-Enter input value in input object.png')

"Step 13: Click on button quantityAdjustments (plus2)"

WebUI.enhancedClick(findTestObject('AI-Generated/Production/Dynamic Objects/Page_checkout/button_quantityAdjustments'))

// WebUI.takeScreenshot(reportLocation + '/TC7/Step 13-Click on button quantityAdjustments plus2.png')
...
// WebUI.takeScreenshot(reportLocation + '/TC7/Step 14-Click on span checkoutProceedButton.png')

"Step 15: Click on span space"

WebUI.enhancedClick(findTestObject('AI-Generated/Production/Page_checkout/span_space'))

// WebUI.takeScreenshot(reportLocation + '/TC7/Step 15-Click on span space.png')

"Step 16: Click on span checkoutProceedButton"

WebUI.enhancedClick(findTestObject('AI-Generated/Production/Page_checkout/span_checkoutProceedButton'))

// WebUI.takeScreenshot(reportLocation + '/TC7/Step 16-Click on span checkoutProceedButton.png')
...
// WebUI.takeScreenshot(reportLocation + '/TC7/Step 17-Click on span checkoutButton2.png')
...
// WebUI.takeScreenshot(reportLocation + '/TC7/Step 18-Click on button backToCart.png')

"Step 19: Click on button backToCart"

WebUI.enhancedClick(findTestObject('AI-Generated/Production/Page_checkout/button_backToCart'))

// WebUI.takeScreenshot(reportLocation + '/TC7/Step 19-Click on button backToCart.png')
...
// WebUI.takeScreenshot(reportLocation + '/TC7/Step 20-Click on button store - Navigate to page store.png')

"Step 21: Click on button addToCart (addToCart5)"
...
// WebUI.takeScreenshot(reportLocation + '/TC7/Step 21-Click on button addToCart addToCart5.png')
...
// WebUI.takeScreenshot(reportLocation + '/TC7/Step 22-Click on span shoppingCartLabel - Navigate to page checkout.png')
...
// WebUI.takeScreenshot(reportLocation + '/TC7/Step 23-Click on div checkoutInfo.png')
...
// WebUI.takeScreenshot(reportLocation + '/TC7/Step 24-Click on span checkoutAction.png')

"Step 25: Click on button store -> Navigate to page '/store'"

WebUI.enhancedClick(findTestObject('AI-Generated/Production/Page_checkout/button_store'))

// WebUI.takeScreenshot(reportLocation + '/TC7/Step 25-Click on button store - Navigate to page store.png')

"Step 26: Click on button addToCart (addToCart8)"
...
// WebUI.takeScreenshot(reportLocation + '/TC7/Step 26-Click on button addToCart addToCart8.png')

"Step 27: Click on button addToCart (addToCart9)"
...
// WebUI.takeScreenshot(reportLocation + '/TC7/Step 27-Click on button addToCart addToCart9.png')
...
// WebUI.takeScreenshot(reportLocation + '/TC7/Step 28-Click on div productList - Navigate to page .png')

"Step 29: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC7-Add Multiple Items to Cart and Checkout Process_visual_checkpoint')
