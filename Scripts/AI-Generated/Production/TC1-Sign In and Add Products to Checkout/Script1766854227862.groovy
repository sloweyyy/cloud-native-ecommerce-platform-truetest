...
// WebUI.takeScreenshot(reportLocation + '/TC1/Step 2-Click on button signIn.png')

"Step 3: Click on button store -> Navigate to page '/store'"

WebUI.enhancedClick(findTestObject('AI-Generated/Production/Page_home/button_store'))

// WebUI.takeScreenshot(reportLocation + '/TC1/Step 3-Click on button store - Navigate to page store.png')
...
// WebUI.takeScreenshot(reportLocation + '/TC1/Step 5-Click on item signIn - Navigate to page login.png')
...
// WebUI.takeScreenshot(reportLocation + '/TC1/Step 6-Click on button signInWithAzureAd.png')

"Step 7: Click on button signInWithAzureAd -> Navigate to page '/'"

WebUI.enhancedClick(findTestObject('AI-Generated/Production/Page_login/button_signInWithAzureAd'))

// WebUI.takeScreenshot(reportLocation + '/TC1/Step 7-Click on button signInWithAzureAd - Navigate to page .png')

"Step 8: Click on button cart -> Navigate to page '/checkout'"

WebUI.enhancedClick(findTestObject('AI-Generated/Production/Page_home/button_cart'))

// WebUI.takeScreenshot(reportLocation + '/TC1/Step 8-Click on button cart - Navigate to page checkout.png')

"Step 9: Click on div productDetails"

WebUI.enhancedClick(findTestObject('AI-Generated/Production/Page_checkout/div_productDetails'))

// WebUI.takeScreenshot(reportLocation + '/TC1/Step 9-Click on div productDetails.png')

"Step 10: Click on button store -> Navigate to page '/store'"

WebUI.enhancedClick(findTestObject('AI-Generated/Production/Page_checkout/button_store'))

// WebUI.takeScreenshot(reportLocation + '/TC1/Step 10-Click on button store - Navigate to page store.png')
...
// WebUI.takeScreenshot(reportLocation + '/TC1/Step 11-Click on button addToCart addToCart.png')

"Step 12: Click on span productCardButton"

WebUI.enhancedClick(findTestObject('AI-Generated/Production/Page_store/span_productCardButton'))

// WebUI.takeScreenshot(reportLocation + '/TC1/Step 12-Click on span productCardButton.png')

"Step 13: Click on button checkout -> Navigate to page '/checkout'"

WebUI.enhancedClick(findTestObject('AI-Generated/Production/Page_store/button_checkout'))

// WebUI.takeScreenshot(reportLocation + '/TC1/Step 13-Click on button checkout - Navigate to page checkout.png')

"Step 14: Click on div productDetails2 -> Navigate to page '/store'"

WebUI.enhancedClick(findTestObject('AI-Generated/Production/Page_checkout/div_productDetails2'))

// WebUI.takeScreenshot(reportLocation + '/TC1/Step 14-Click on div productDetails2 - Navigate to page store.png')

"Step 15: Click on span productCategories (mice) -> Navigate to page ''"
...
// WebUI.takeScreenshot(reportLocation + '/TC1/Step 15-Click on span productCategories mice - Navigate to page .png')

"Step 16: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC1-Sign In and Add Products to Checkout_visual_checkpoint')
