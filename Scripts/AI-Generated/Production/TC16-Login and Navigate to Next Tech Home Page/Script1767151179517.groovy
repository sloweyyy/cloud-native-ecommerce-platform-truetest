...
def setup() {
	WebUI.openBrowser('')
	WebUI.setViewPortSize(1223, 926)
...
// WebUI.takeScreenshot(reportLocation + '/TC16/Step 4-Click on button userMenu.png')
...
// WebUI.takeScreenshot(reportLocation + '/TC16/Step 5-Click on item signIn3 - Navigate to page login.png')
...
// WebUI.takeScreenshot(reportLocation + '/TC16/Step 6-Click on button signInWithAzureAd2 - Navigate to page .png')

"Step 7: Click on button nextTechHome -> Navigate to page ''"

WebUI.enhancedClick(findTestObject('AI-Generated/Production/Page_home/button_nextTechHome'))

// WebUI.takeScreenshot(reportLocation + '/TC16/Step 7-Click on button nextTechHome - Navigate to page .png')

"Step 8: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC16-Login and Navigate to Next Tech Home Page_visual_checkpoint')
