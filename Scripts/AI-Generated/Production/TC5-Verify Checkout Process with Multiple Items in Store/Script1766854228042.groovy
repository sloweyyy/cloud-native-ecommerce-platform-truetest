...
// WebUI.takeScreenshot(reportLocation + '/TC5/Step 2-Click on button signIn.png')

"Step 3: Click on item signIn -> Navigate to page '/login'"

WebUI.enhancedClick(findTestObject('AI-Generated/Production/Page_home/item_signIn'))

// WebUI.takeScreenshot(reportLocation + '/TC5/Step 3-Click on item signIn - Navigate to page login.png')

"Step 4: Click on button signInWithAzureAd2 -> Navigate to page '/'"

WebUI.enhancedClick(findTestObject('AI-Generated/Production/Page_login/button_signInWithAzureAd2'))

// WebUI.takeScreenshot(reportLocation + '/TC5/Step 4-Click on button signInWithAzureAd2 - Navigate to page .png')
...
// WebUI.takeScreenshot(reportLocation + '/TC5/Step 5-Click on button store - Navigate to page store.png')
...
// WebUI.takeScreenshot(reportLocation + '/TC5/Step 6-Click on button addToCart addToCart2.png')

"Step 7: Click on button checkout -> Navigate to page '/checkout'"

WebUI.enhancedClick(findTestObject('AI-Generated/Production/Page_store/button_checkout'))

// WebUI.takeScreenshot(reportLocation + '/TC5/Step 7-Click on button checkout - Navigate to page checkout.png')

"Step 8: Click on button checkoutOptions (continueShopping2)"
...
// WebUI.takeScreenshot(reportLocation + '/TC5/Step 8-Click on button checkoutOptions continueShopping2.png')
...
// WebUI.takeScreenshot(reportLocation + '/TC5/Step 9-Click on button checkoutOptions proceedToCheckout.png')

"Step 10: Click on button checkoutOptions (proceedToCheckout)"
...
// WebUI.takeScreenshot(reportLocation + '/TC5/Step 10-Click on button checkoutOptions proceedToCheckout.png')

"Step 11: Click on div checkoutSummary"

WebUI.enhancedClick(findTestObject('AI-Generated/Production/Page_checkout/div_checkoutSummary'))

// WebUI.takeScreenshot(reportLocation + '/TC5/Step 11-Click on div checkoutSummary.png')

"Step 12: Click on main orderSummary"

WebUI.enhancedClick(findTestObject('AI-Generated/Production/Page_checkout/main_orderSummary'))

// WebUI.takeScreenshot(reportLocation + '/TC5/Step 12-Click on main orderSummary.png')

"Step 13: Click on button nextTechHome -> Navigate to page '/'"

WebUI.enhancedClick(findTestObject('AI-Generated/Production/Page_checkout/button_nextTechHome'))

// WebUI.takeScreenshot(reportLocation + '/TC5/Step 13-Click on button nextTechHome - Navigate to page .png')

"Step 14: Click on button store -> Navigate to page '/store'"

WebUI.enhancedClick(findTestObject('AI-Generated/Production/Page_home/button_store'))

// WebUI.takeScreenshot(reportLocation + '/TC5/Step 14-Click on button store - Navigate to page store.png')
...
// WebUI.takeScreenshot(reportLocation + '/TC5/Step 15-Click on button addToCart addToCart3.png')

"Step 16: Click on button cartActions (cart) -> Navigate to page '/checkout'"
...
// WebUI.takeScreenshot(reportLocation + '/TC5/Step 16-Click on button cartActions cart - Navigate to page checkout.png')

"Step 17: Click on button checkoutOptions (proceedToCheckout) -> Navigate to page ''"
...
// WebUI.takeScreenshot(reportLocation + '/TC5/Step 17-Click on button checkoutOptions proceedToCheckout - Navigate to page .png')

"Step 18: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC5-Verify Checkout Process with Multiple Items in Store_visual_checkpoint')
