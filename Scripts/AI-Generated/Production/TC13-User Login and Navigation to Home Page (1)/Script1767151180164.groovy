...
// WebUI.takeScreenshot(reportLocation + '/TC13/Step 4-Click on button userMenu.png')
...
// WebUI.takeScreenshot(reportLocation + '/TC13/Step 5-Click on item signIn4 - Navigate to page login.png')
...
// WebUI.takeScreenshot(reportLocation + '/TC13/Step 6-Click on button signInWithAzureAd3 - Navigate to page .png')

"Step 7: Click on item signIn4 -> Navigate to page ''"

WebUI.enhancedClick(findTestObject('AI-Generated/Production/Page_home/item_signIn4'))

// WebUI.takeScreenshot(reportLocation + '/TC13/Step 7-Click on item signIn4 - Navigate to page .png')

"Step 8: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC13-User Login and Navigation to Home Page (1)_visual_checkpoint')
