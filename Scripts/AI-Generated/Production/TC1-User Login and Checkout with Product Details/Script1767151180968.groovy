...
// WebUI.takeScreenshot(reportLocation + '/TC1/Step 4-Click on button userMenu.png')
...
// WebUI.takeScreenshot(reportLocation + '/TC1/Step 7-Click on item signIn - Navigate to page login.png')

"Step 8: Click on button signInWithAzureAd2"

WebUI.enhancedClick(findTestObject('AI-Generated/Production/Page_login/button_signInWithAzureAd2'))

// WebUI.takeScreenshot(reportLocation + '/TC1/Step 8-Click on button signInWithAzureAd2.png')
...
// WebUI.takeScreenshot(reportLocation + '/TC1/Step 9-Click on button signInWithAzureAd3 - Navigate to page .png')

"Step 10: Click on button cart2 -> Navigate to page '/checkout'"

WebUI.enhancedClick(findTestObject('AI-Generated/Production/Page_home/button_cart2'))

// WebUI.takeScreenshot(reportLocation + '/TC1/Step 10-Click on button cart2 - Navigate to page checkout.png')
...
"Step 13: Click on button addToCart (addToCart5)"
...
// WebUI.takeScreenshot(reportLocation + '/TC1/Step 13-Click on button addToCart addToCart5.png')
...
"Step 17: Click on span productTypes (mice) -> Navigate to page ''"
...
// WebUI.takeScreenshot(reportLocation + '/TC1/Step 17-Click on span productTypes mice - Navigate to page .png')

"Step 18: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC1-User Login and Checkout with Product Details_visual_checkpoint')
